...
((Drupal) => {
  const { isDesktopNav } = Drupal.myolivero;
  ...
  Drupal.myolivero.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.myolivero.isDesktopNav()) return;
  ...
  Drupal.myolivero.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.myolivero.areAnySubNavsOpen = areAnySubNavsOpen;
