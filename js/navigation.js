...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.myolivero.areAnySubNavsOpen()) {
          props.myolivero.closeAllSubNav();
        } else {
    ...
    window.addEventListener('resize', () => {
      if (props.myolivero && props.myolivero.isDesktopNav()) {
        toggleNav(props, false);
        props.body.classList.remove('is-overlay-active');
        props.body.classList.remove('is-fixed');
        // Comment this closeAll statement if you use submenus and uncomment the line indicated below.
        Drupal.myolivero.closeAllSubNav();
      }

      // Uncomment this if you use submenus. Ensure that all sub-navigation menus close when the browser is resized.
      // Drupal.myolivero.closeAllSubNav();
    });
   ...
   */
  Drupal.behaviors.myoliveroNavigation = {
    attach(context) {
